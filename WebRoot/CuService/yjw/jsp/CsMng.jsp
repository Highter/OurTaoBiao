	...
	<div id="Right_layout">
		<div id="CsShow">
			<table width="100%" border="1">
				...
				<!-- 循环输出客服信息 -->
				<s:iterator value="#session.cusList">
					<tr>
						<td><s:property value="userName"/></td>
						<td><s:property value="passWord"/></td>
						<td><s:property value="cellPhone"/></td>
						<td><s:property value="email"/></td>
						<td><a href="lookUCs?userId=<s:property value='userId'/>" target="view_window">查看</a>&nbsp;
						<a href="change0UCs?userId=<s:property value='userId'/>">更改角色</a>&nbsp;
						<a href="dropUCs?userId=<s:property value='userId'/>">删除</a>&nbsp;
						<a href="addValuesPower?userId=<s:property value='userId'/>" target="view_window">增加权限</a></td>
					</tr>
				</s:iterator>
			</table>
		</div>
