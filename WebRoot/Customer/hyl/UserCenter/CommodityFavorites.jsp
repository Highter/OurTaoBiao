				...
				<div class="us_contentBox default clearfix">
					...
					<div class="body">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							bgcolor="0">
							<tr align="center">
								<td class="item"><strong>ID</strong>
								</td>
								<td class="item"><strong>商品ID</strong>
								</td>
								<td class="item"><strong>商品名字</strong>
								</td>
								<td class="item"><strong>价格</strong>
								</td>
							...
							<s:iterator value="#session.colllist">
							<tr align="center">
								<td class="item"><s:property value="commodityFavoritesId"/></td>
								<td class="item"><s:property value="commodities.commodityId"/>
								<td class="item"><s:property value="commodityName"/></td>
								<td class="item"><s:property value="comFavoPrice"/></td>
								
								<td class="item"><strong><a href="collectLook=<s:property value='commodities.commodityId'/>" target="_blank">查看</a><br />
								<a href="collectDelete?commodityFavoritesId=<s:property value='commodityFavoritesId'/>&userId=<s:property value='#session.user.userId'/>">删除</a>
							</strong>
							</td>
							</tr>
						</s:iterator>
