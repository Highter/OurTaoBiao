		...
		<div class="block clearfix">
			<div class="EarLeft fl">
				<div class="attrbox">
					...
					<div class="attrcontent">
						<ul class="userMenu">
							<li><a href="Customer/hyl/UserCenter/userindex.jsp"> 欢迎页</a></li>
			...
			<div class="EarRight fr">
				<div class="us_contentBox">
					...
					<s:debug></s:debug>
					<!----> <form action="addressadd?userId=<s:property value='#session.user.userId'/>" method="post" id="theForm"
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<tr>
								...
								<td colspan="3" align="center" bgcolor="#ffffff"><input
									type="submit" name="submit" class="bnt_number4" value="增加地址"  />
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<s:iterator value="#session.addresslist">
							<tr align="center">
								...
								<td class="item"><strong><a href="myaddress?addressid=<s:property value='addressId'/>&userId=<s:property value='user.userId'/>">编辑</a><br />
								<a href="addressdelete?addressid=<s:property value='addressId'/>&userId=<s:property value='user.userId'/>">删除</a>
							</strong>
							</td>
							</tr>
						</s:iterator>
